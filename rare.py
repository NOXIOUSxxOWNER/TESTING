...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        ...
        bot.reply_to(message, welcome_message, reply_markup=get_inline_keyboard())
...
def rules(message):
    ...
    bot.reply_to(message, rules_message, reply_markup=get_inline_keyboard())
...
def help_command(message):
    ...
    bot.reply_to(message, help_message, reply_markup=get_inline_keyboard())
